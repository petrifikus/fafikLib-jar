...
//		}
		...
		size_t getIndex( iterator it )const{
...
//		}
		...
		bool isWithBytes() const{ if(ByteData_itemEntry_selfEntry) return true; return false; }
...
//		}
		...
		virtual wxLongLong Adv_getNumber_LL(){return 0;}
			...
			///2019-10-09
		static bool _operLowerB_compareIE( iterator item, const itemEntry& compa );
	 protected:
...
// end of public:
 protected:
// 	itemEntry* getItem_byKey_rec(itemEntry &Table, const wxArrayString& findKey_levelRecursive, size_t currPos=0, BYTE is_interpreter=2);
